...
export type ContractReviveConstructor<ApiType extends ApiTypes> = new (
  api: ApiBase<ApiType>,
  abi: string | Record<string, unknown> | Abi,
  address: string | AccountId,
) => ContractRevive<ApiType>;
...
export declare class ContractRevive<ApiType extends ApiTypes> extends BaseRevive<ApiType> {
  #private;
  /**
...
export declare function extendContract<ApiType extends ApiTypes>(
  type: ApiType,
  decorateMethod: DecorateMethod<ApiType>,
): ContractReviveConstructor<ApiType>;
