(function (global, factory) {
    ...
    __internal__createArgs = (args, spec) => {
      return args.map(({ label, type }, index) => {
        try {
          ...
          l$2.error(`Error expanding argument ${index} in ${util.stringify(spec)}`);
          throw error;
        }
      });
    };
  ...
  class Base {
    ...
    constructor(api, abi, decorateMethod) {
      if (!api || !api.isConnected || !api.tx) {
        ...
        !api.tx.contracts ||
        !util.isFunction(api.tx.contracts.instantiateWithCode) ||
  ...
  const MAX_CALL_GAS$1 = new util.BN(5_000_000_000_000).isub(util.BN_ONE);
  const l$1 = util.logger('Contract');
  function createQuery$1(meta, fn) {
    return withMeta(meta, (origin, options, ...params) => fn(origin, options, params));
  }
  function createTx$1(meta, fn) {
    return withMeta(meta, (options, ...params) => fn(options, params));
  }
  let ContractSubmittableResult$1 = class ContractSubmittableResult extends api.SubmittableResult {
    contractEvents;
  ...
  class Contract extends Base {
    ...
    constructor(api, abi, address, decorateMethod) {
      ...
      this.abi.messages.forEach(m => {
        if (util.isUndefined(this.__internal__tx[m.method])) {
          this.__internal__tx[m.method] = createTx$1(m, (o, p) => this.__internal__exec(m, o, p));
        }
        if (util.isUndefined(this.__internal__query[m.method])) {
          this.__internal__query[m.method] = createQuery$1(m, (f, o, p) =>
    ...
    __internal__exec = (
      ...
      return this.api.tx.contracts
        ...
        .withResultTransform(
          result =>
            new ContractSubmittableResult$1(
              result,
                ...
                records
                  .map(record => {
                    try {
                      ...
                      l$1.error(`Unable to decode contract event: ${error.message}`);
                      return null;
                    }
                  })
  ...
  class BlueprintRevive extends BaseRevive {
    codeHash;
    __internal__tx = {};
    constructor(api, abi, codeHash, decorateMethod) {
      super(api, abi, decorateMethod);
  ...
  class Code extends Base {
    ...
    constructor(api, abi, wasm, decorateMethod) {
      super(api, abi, decorateMethod);
      this.code = isValidCode$1(this.abi.info.source.wasm)
        ? this.abi.info.source.wasm
        : util.u8aToU8a(wasm);
      if (!isValidCode$1(this.code)) {
  ...
  class CodeReviveSubmittableResult extends api.SubmittableResult {
    blueprint;
    contract;
    constructor(result, blueprint, contract) {
      super(result);
  ...
  function isValidCode(code) {
    return util.isRiscV(code);
  }
  class CodeRevive extends BaseRevive {
    code;
    __internal__tx = {};
    constructor(api, abi, wasm, decorateMethod) {
      super(api, abi, decorateMethod);
  ...
  class ContractRevive extends BaseRevive {
    address;
    __internal__query = {};
    __internal__tx = {};
    constructor(api, abi, address, decorateMethod) {
  ...
  class BlueprintRevivePromise extends BlueprintRevive {
    constructor(api$1, abi, codeHash) {
      super(api$1, abi, codeHash, api.toPromiseMethod);
    }
  }
  class CodeRevivePromise extends CodeRevive {
    constructor(api$1, abi, wasm) {
      super(api$1, abi, wasm, api.toPromiseMethod);
    }
  }
  class ContractRevivePromise extends ContractRevive {
    constructor(api$1, abi, address) {
      super(api$1, abi, address, api.toPromiseMethod);
    }
  }
