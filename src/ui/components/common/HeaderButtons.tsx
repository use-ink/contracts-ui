    ...
    <div className="inline-flex dark:text-gray-300 relative h-8 text-xs right-0">
      <div className="inline-flex h-8">
        <Link to={`/instantiate/${contract.codeHash}`}>
          <button className="flex font-medium items-center dark:text-gray-300 dark:bg-elevation-1 dark:hover:bg-elevation-2 dark:border-gray-700 border h-full px-3 rounded">
